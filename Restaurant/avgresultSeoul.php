...
<?php
                ...
                if(mysqli_connect_error()){
                    ...
                    $sql = "SELECT AVG(PRICE) AS avg_price FROM SeoulRestaurant WHERE TYPE = '".$_POST['type']."'";
...
<?php
                ...
                if(mysqli_connect_error()){
                    ...
                    exit();
                            ...
                            $sql = "SELECT NAME, MENU, PRICE, GU FROM SeoulRestaurant WHERE TYPE = '" . $_POST['type'] . "'";
                            $res = mysqli_query($mysqli, $sql);
                            ...
                            if ($res && mysqli_num_rows($res) > 0) {
                                ...
                                echo '서울 '.$_POST['type'].' 식당의 대표메뉴와 가격';
                                ...
                                echo "</table>";
                                echo "</span>";
                                $sql2 = "SELECT AVG(PRICE) AS avg_price FROM SeoulRestaurant WHERE TYPE = '".$_POST['type']."'";
